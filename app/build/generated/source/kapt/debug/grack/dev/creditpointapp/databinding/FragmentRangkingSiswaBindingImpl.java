...
public class FragmentRangkingSiswaBindingImpl extends FragmentRangkingSiswaBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((grack.dev.creditpointapp.features.dashboard.ui.rangking.RangkingSiswaViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable grack.dev.creditpointapp.features.dashboard.ui.rangking.RangkingSiswaViewModel ViewModel) {
