...
public class ActivityInputPointBindingImpl extends ActivityInputPointBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.InputPointViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.InputPointViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelDetailSiswa((androidx.lifecycle.MutableLiveData<grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.DetailSiswaModel>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelDetailSiswa(androidx.lifecycle.MutableLiveData<grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.DetailSiswaModel> ViewModelDetailSiswa, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.DetailSiswaModel> viewModelDetailSiswa = null;
        ...
        grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.DetailSiswaModel viewModelDetailSiswaGetValue = null;
        ...
        grack.dev.creditpointapp.features.dashboard.ui.inputsiswa.InputPointViewModel viewModel = mViewModel;
